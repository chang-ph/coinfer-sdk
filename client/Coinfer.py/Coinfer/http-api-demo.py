...
# login
res = session.post(f"{BASE_URL}/base/login", data=json.dumps({
    "username": "admin",
    "password": "admin",
}))
response_data(res)
...
res = session.post(f"{BASE_URL}/turing/object",
                   data=json.dumps({"object_type": "model",
...
input_id = ""
res = session.post(f"{BASE_URL}/turing/object",
                   data=json.dumps({"object_type": "task",
                                    "model_id": model_id,
                                    "input_id": input_id,
                                    }))
rdata = response_data(res)
