...
Base.@kwdef mutable struct CreateDataRsp <: OpenAPI.APIModel
    ...
    function CreateDataRsp(object_type, name, description, short_id, created_at, updated_at, )
...
const _property_types_CreateDataRsp = Dict{Symbol,String}(Symbol("object_type")=>"String", Symbol("name")=>"String", Symbol("description")=>"String", Symbol("short_id")=>"String", Symbol("created_at")=>"ZonedDateTime", Symbol("updated_at")=>"ZonedDateTime", )
