...
@doc raw"""CreateModel
    ...
    - tags::Vector{CloudFunctionKind} : Model tags
...
Base.@kwdef mutable struct CreateModel <: OpenAPI.APIModel
    ...
    tags::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{CloudFunctionKind} }
    ...
    function CreateModel(object_type, type, env, name, content, tags, single_instance, lang, entrance_file, lambda_image, source_url, )
        ...
        OpenAPI.validate_property(CreateModel, Symbol("tags"), tags)
        ...
        return new(object_type, type, env, name, content, tags, single_instance, lang, entrance_file, lambda_image, source_url, )
    end
end # type CreateModel

const _property_types_CreateModel = Dict{Symbol,String}(Symbol("object_type")=>"String", Symbol("type")=>"String", Symbol("env")=>"String", Symbol("name")=>"String", Symbol("content")=>"ModelContent", Symbol("tags")=>"Vector{CloudFunctionKind}", Symbol("single_instance")=>"Bool", Symbol("lang")=>"CloudFunctionLang", Symbol("entrance_file")=>"String", Symbol("lambda_image")=>"Bool", Symbol("source_url")=>"String", )
