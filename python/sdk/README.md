...
*ExperimentApi* | [**experiment_notebook_colab**](docs/ExperimentApi.md#experiment_notebook_colab) | **GET** /mcmc/experiment/{expid}/notebook/colab | [DEPRECATED] Get a link of the notebook in Colab
*ExperimentApi* | [**view_xp_cloudwatch_logs**](docs/ExperimentApi.md#view_xp_cloudwatch_logs) | **GET** /mcmc/object/{objid}/cloudwatch-logs | [DEPRECATED] Get Cloudwatch logs
*ModelApi* | [**get_config**](docs/ModelApi.md#get_config) | **GET** /turing/config | [DEPRECATED] Get configuration about how to run a model.
*ModelApi* | [**list_branch**](docs/ModelApi.md#list_branch) | **GET** /turing/github/branch | [DEPRECATED] List branches.
*ModelApi* | [**list_repository**](docs/ModelApi.md#list_repository) | **GET** /turing/github/repository | [DEPRECATED] List repositories and gists.
