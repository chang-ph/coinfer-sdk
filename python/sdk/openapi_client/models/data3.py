...
DATA3_ANY_OF_SCHEMAS = ["ExperimentRsp", "ViewModelsRsp"]
...
class Data3(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Data3.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Data3 with anyOf schemas: ExperimentRsp, ViewModelsRsp. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Data3 with anyOf schemas: ExperimentRsp, ViewModelsRsp. Details: " + ", ".join(error_messages))
        else:
            return instance
