...
class RunCommandReq(BaseModel):
    ...
    RunCommandReq
    """ # noqa: E501
    target: StrictStr = Field(description="Target object to perform the action on")
    ...
    get_response: Optional[StrictBool] = Field(default=False, description="Whether to get the response from the command (Sync run)")
    __properties: ClassVar[List[str]] = ["target", "action", "parameters", "get_response"]
