...
class SoftDeletedRsp(BaseModel):
    """
    SoftDeletedRsp
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if deleted_key (nullable) is None
        # and model_fields_set contains the field
        if self.deleted_key is None and "deleted_key" in self.model_fields_set:
            _dict['deleted_key'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deleted_key": obj.get("deleted_key")
        })
        return _obj
