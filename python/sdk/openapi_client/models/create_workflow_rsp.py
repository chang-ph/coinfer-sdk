...
class CreateWorkflowRsp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object_type", "short_id", "name", "model_id", "model_name", "data_id", "data_name", "data_fmt", "experiment_id", "experiment_name", "analyzer_id", "analyzer_name", "created_at", "updated_at", "startup_script", "settings", "data_script"]
