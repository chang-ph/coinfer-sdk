...
class CreateExperiment(BaseModel):
    ...
    data_files: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=10)]] = Field(default=None, description="File data in base64 format")
    __properties: ClassVar[List[str]] = ["object_type", "model_id", "xp_meta", "meta", "name", "data_files"]
