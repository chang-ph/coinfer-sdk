...
class CreateExperiment(BaseModel):
    ...
    data_file_type: Optional[StrictStr] = 'csv'
    data_files: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="File data in text format")
    __properties: ClassVar[List[str]] = ["object_type", "model_id", "xp_meta", "meta", "name", "data_file_type", "data_files"]
    ...
    def data_file_type_validate_enum(cls, value):
        ...
        if value not in set(['csv', 'stan_csv', 'arviz']):
            raise ValueError("must be one of enum values ('csv', 'stan_csv', 'arviz')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data_file_type": obj.get("data_file_type") if obj.get("data_file_type") is not None else 'csv',
