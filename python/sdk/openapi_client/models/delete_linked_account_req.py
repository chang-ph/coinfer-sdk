...
class DeleteLinkedAccountReq(BaseModel):
    """
    DeleteLinkedAccountReq
    """ # noqa: E501
    deleted_key: Optional[StrictStr] = ''
    accounts: Optional[List[StrictStr]] = Field(default=None, description="account list. List item in format `<account_type>:<account>`")
    __properties: ClassVar[List[str]] = ["deleted_key", "accounts"]
