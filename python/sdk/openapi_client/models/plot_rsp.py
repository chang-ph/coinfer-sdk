...
class PlotRsp(BaseModel):
    """
    PlotRsp
    """ # noqa: E501
    plot_data: Optional[Any]
    __properties: ClassVar[List[str]] = ["plot_data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if plot_data (nullable) is None
        # and model_fields_set contains the field
        if self.plot_data is None and "plot_data" in self.model_fields_set:
            _dict['plot_data'] = None
