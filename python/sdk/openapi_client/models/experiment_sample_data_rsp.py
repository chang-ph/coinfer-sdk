...
class ExperimentSampleDataRsp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["object_type", "url", "progress", "message"]

    @field_validator('object_type')
    def object_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['experiment.sampledata']):
            raise ValueError("must be one of enum values ('experiment.sampledata')")
        return value
