...
class ModelContent(BaseModel):
    ...
    tree: Optional[List[ModelTreeNode]] = None
    __properties: ClassVar[List[str]] = ["meta", "tree"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": ModelMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "tree": [ModelTreeNode.from_dict(_item) for _item in obj["tree"]] if obj.get("tree") is not None else None
        })
        return _obj
