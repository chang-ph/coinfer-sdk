...
DATA1_ANY_OF_SCHEMAS = ["CreateExperimentShareRsp", "ExperimentRsp", "ListModelsRspItem"]
...
class Data1(BaseModel):
    ...
    anyof_schema_3_validator: Optional[CreateExperimentShareRsp] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[CreateExperimentShareRsp, ExperimentRsp, ListModelsRspItem]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "CreateExperimentShareRsp", "ExperimentRsp", "ListModelsRspItem" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Data1 with anyOf schemas: CreateExperimentShareRsp, ExperimentRsp, ListModelsRspItem. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Data1 with anyOf schemas: CreateExperimentShareRsp, ExperimentRsp, ListModelsRspItem. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], CreateExperimentShareRsp, ExperimentRsp, ListModelsRspItem]]:
