...
class DeleteTokenReq(BaseModel):
    """
    DeleteTokenReq
    """ # noqa: E501
    deleted_key: Optional[StrictStr] = ''
    tokens: Optional[List[StrictStr]] = Field(default=None, description="list of tokens to be deleted")
    __properties: ClassVar[List[str]] = ["deleted_key", "tokens"]
