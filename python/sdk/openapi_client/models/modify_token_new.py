...
class ModifyTokenNew(BaseModel):
    """
    ModifyTokenNew
    """ # noqa: E501
    type: Optional[StrictStr] = 'update_token'
    id: StrictInt
    name: Optional[StrictStr] = None
    desc: Optional[StrictStr] = None
    expire: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["type", "id", "name", "desc", "expire"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['update_token']):
            raise ValueError("must be one of enum values ('update_token')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'update_token',
            "id": obj.get("id"),
            "name": obj.get("name"),
            "desc": obj.get("desc"),
