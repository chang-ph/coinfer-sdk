...
class Folder(BaseModel):
    ...
    children: List[FolderChildrenInner]
    __properties: ClassVar[List[str]] = ["name", "type", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [FolderChildrenInner.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
