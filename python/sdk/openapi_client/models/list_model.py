...
class ListModel(BaseModel):
    ...
    kind: Optional[CloudFunctionKind] = Field(default=None, description="Filter by kind")
    __properties: ClassVar[List[str]] = ["page_no", "page_size", "object_type", "with_share_info", "shared_by_me", "shared_with_me", "model_ids", "kind"]
