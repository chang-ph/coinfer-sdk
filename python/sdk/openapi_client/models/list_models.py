...
class ListModels(BaseModel):
    ...
    shared_by_me: Optional[StrictBool] = Field(default=False, description="Filter models shared by the current user")
    shared_with_me: Optional[StrictBool] = Field(default=False, description="Filter models shared with the current user")
    __properties: ClassVar[List[str]] = ["page_no", "page_size", "model_ids", "with_share_info", "shared_by_me", "shared_with_me"]
