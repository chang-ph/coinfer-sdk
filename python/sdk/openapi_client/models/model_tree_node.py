...
class ModelTreeNode(BaseModel):
    ...
    children: Optional[List[ModelTreeNode]] = None
    __properties: ClassVar[List[str]] = ["name", "type", "content", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [ModelTreeNode.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ModelTreeNode.model_rebuild(raise_errors=False)
