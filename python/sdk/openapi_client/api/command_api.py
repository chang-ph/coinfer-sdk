...
class CommandApi:
    ...
    def run_command(
        ...
        :param run_command_req: (required)
        :type run_command_req: RunCommandReq
        ...
        _param = self._run_command_serialize(
            run_command_req=run_command_req,
    ...
    def _run_command_serialize(
        ...
        if run_command_req is not None:
            _body_params = run_command_req
